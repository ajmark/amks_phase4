...
class RegistrationTest < ActiveSupport::TestCase
  ...
  context "Creating registrations context" do
    ...
    should "show proper counts for registrants in each section" do
      assert_equal 2, @wy_belt_sparring.registrations.size
      assert_equal 1, @wy_belt_breaking.registrations.size
      assert_equal 2, @r_belt_breaking.registrations.size
      assert_equal 0, @r_belt_sparring.registrations.size
      assert_equal 0, @bl_belt_breaking.registrations.size
    end
